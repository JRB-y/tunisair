...
class AdminConventionController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('conventions.index')->with('conventions', $conventions);
    }
    ...
    {
        $types = Type::all();
        return view('conventions.create')->with('types', $types);
    }
    ...
    public function edit($id)
    {
        ...
        $types = Type::all();
        return view('conventions.edit')->with('convention', $convention)->with('types', $types);
    }
